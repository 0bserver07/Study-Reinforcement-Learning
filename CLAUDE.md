...
Read [`AGENTS.md`](./AGENTS.md). Everything in it applies to Claude Code working in this repo.
...
- When tutoring on an exercise, give the *next* hint from `HINTS.md`, not the solution.

If the user asks you to act as a tutor for a lecture or exercise, read the relevant file under `notes/lectures/` first, check its status, and tell the user if it's `unreviewed` (so they know to take it with a grain of salt).
