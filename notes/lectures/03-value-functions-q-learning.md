...
If you know Q*(s,a) for the optimal policy, you can act optimally just by taking the max:
```
π*(s) = argmax_a Q*(s,a)
```
...
# Assumes SimpleDQN (Part 3) and ReplayBuffer (Part 4) are defined above.
